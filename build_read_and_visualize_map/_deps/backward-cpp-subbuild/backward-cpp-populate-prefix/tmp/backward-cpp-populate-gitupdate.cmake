...
execute_process(
  COMMAND "/usr/bin/git" show-ref v1.6
  WORKING_DIRECTORY "/media/cc/DATA/git/ScanNet-SG/build_read_and_visualize_map/_deps/backward-cpp-src"
...
if("${show_ref_output}" MATCHES "refs/remotes/v1.6")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "v1.6")
...
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 v1.6
  WORKING_DIRECTORY "/media/cc/DATA/git/ScanNet-SG/build_read_and_visualize_map/_deps/backward-cpp-src"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/bombela/backward-cpp.git'")
  endif()
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/media/cc/DATA/git/ScanNet-SG/build_read_and_visualize_map/_deps/backward-cpp-src/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/media/cc/DATA/git/ScanNet-SG/build_read_and_visualize_map/_deps/backward-cpp-src/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
