...
```bash
python scannet/script/matcher_data_generation.py --add_cross_scan --scene_exclude_csv_path xxx --map_folder xxx/processed/scans --data_output_dir xxx --save_every_n_scenes 100
```
